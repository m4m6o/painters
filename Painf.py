...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.coords.move(10, WIDTH - 30)
        # Создание лэйбла с координатами
        
        self.canvasSize = QLabel(self)
        self.canvasSize.setText("Size: {}, {}".format(HEIGHT, WIDTH))
        self.canvasSize.move(130, int(WIDTH) - 30)
        
        self.show()
        # Создание лэйбла с размерами
    ...
    def save(self):
        filePath, _ = QFileDialog.getSaveFileName(self, "Save file", "", "PNG Image file (*.png)")
        if filePath:
